...
export declare class ChangeStream<TSchema extends Document = Document, TChange extends Document = ChangeStreamDocument<TSchema>> extends TypedEventEmitter<ChangeStreamEvents<TSchema, TChange>> {
    ...
    /* Excluded from this release type: _processErrorIteratorModeCallback */
}
...
export declare type Filter<TSchema> = Partial<TSchema> | ({
    [Property in Join<NestedPaths<WithId<TSchema>, true>, '.'>]?: Condition<PropertyType<WithId<TSchema>, Property, true>>;
 ...
 */
export declare type NestedPaths<Type, AllowToSkipArrayIndex extends boolean> = Type extends unknown ? Type extends string | number | boolean | Date | RegExp | Buffer | Uint8Array | ((...args: any[]) => any) | {
    _bsontype: string;
} ? never : Type extends ReadonlyArray<infer ArrayType> ? [
...((AllowToSkipArrayIndex extends true ? [] : never) | [number | `$${'' | `[${string}]`}`]),
...([] | NestedPaths<ArrayType, AllowToSkipArrayIndex>)
] : Type extends Map<string, any> ? [string] : Type extends object ? {
    ...
    Key,
    ...([] | NestedPaths<Type[Key], AllowToSkipArrayIndex>)
    ] : [
    Key,
    ...([] | NestedPaths<Type[Key], AllowToSkipArrayIndex>)
    ];
}[Extract<keyof Type, string>] : never : never;
